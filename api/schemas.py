...
class TransactionRequest(BaseModel):
    ...
    oldbalanceDest: float = Field(ge=0, default=0.0, description="Beneficiary balance before transaction")
    newbalanceDest: float = Field(ge=0, default=0.0, description="Beneficiary balance after transaction")
