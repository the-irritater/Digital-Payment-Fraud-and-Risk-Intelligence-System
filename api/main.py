...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "sql")))

from predict import FraudPredictor
from risk_engine import RiskEngine
from db_manager import get_db_manager
from api.schemas import (
    TransactionRequest, PredictionResponse, RiskScoreResponse,
...
async def get_model_info():
    ...
    return ModelInfoResponse(
        ...
        risk_engine_weights=meta.get("risk_engine_weights", {"w_ml": 0.6, "w_anomaly": 0.2, "w_rules": 0.2}),
