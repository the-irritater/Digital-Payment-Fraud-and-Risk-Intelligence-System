...
DB_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "data", "processed", "fraud_intelligence.db"))
...
class DatabaseManager:
    ...
    def _seed_sample_cases(self, cursor):
        ...
        initial_cases = [
            ("CASE_92810", "ALT_92810", "TX92831", "C928310482", "C102938", 84500.0, 96.4, "CRITICAL", "BLOCK", "PENDING", "UNASSIGNED", "High nocturnal transfer to unseen beneficiary"),
            ("CASE_92811", "ALT_92811", "TX92832", "C392019481", "C938201", 52100.0, 88.2, "CRITICAL", "BLOCK", "PENDING", "UNASSIGNED", "Velocity spike with complete balance liquidation"),
            ("CASE_92812", "ALT_92812", "TX92833", "C482019482", "C849201", 23500.0, 68.5, "HIGH", "REVIEW", "UNDER_REVIEW", "Analyst_042", "Step-up authentication requested"),
            ("CASE_92813", "ALT_92813", "TX92834", "C192039482", "C192039", 73200.0, 91.0, "CRITICAL", "BLOCK", "CONFIRMED_FRAUD", "Analyst_018", "Confirmed phishing fraud"),
            ("CASE_92814", "ALT_92814", "TX92835", "C281920482", "M281920", 1850.0, 24.1, "LOW", "ALLOW", "FALSE_POSITIVE", "Analyst_042", "Verified normal merchant payment")
        ]
        cursor.executemany("""
    ...
    def log_evaluation(self, tx_dict: Dict[str, Any], risk_result: Dict[str, Any]) -> str:
    ...
    def update_case_decision(self, case_id: str, status: str, analyst_id: str, notes: str):
        with self.get_connection() as conn:
            cursor = conn.cursor()
            cursor.execute("""
