...
class FraudGraphAnalyzer:
    ...
    def build_graph_from_dataframe(
        ...
        print(
            f"[FraudGraphAnalyzer] Constructing MultiDiGraph from {len(df):,} transactions..."
        )
        self.graph.clear()
        ...
        print(
            f"[FraudGraphAnalyzer] MultiDiGraph built: {self.graph.number_of_nodes():,} nodes | {self.graph.number_of_edges():,} directed transaction edges."
        )
