...
class FraudPredictor:
    ...
    def _load_artifacts(self):
        ...
        if os.path.exists(self.meta_path):
            with open(self.meta_path, 'r') as f:
                ...
                self.feature_schema_version = self.meta.get("feature_schema_version", "unknown")
    ...
    def predict_single(self, transaction_dict: Dict[str, Any], update_state: bool = True) -> Dict[str, Any]:
        """
